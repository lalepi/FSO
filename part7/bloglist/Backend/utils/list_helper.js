...
const mostBlogs = (blogs) => {
    const blogCount = Object.entries(
    ...
    const mostAmount = _.reduce(blogCount, (prev, current) =>
...
const mostLikes = (blogs) => {
    const likeCount = Object.entries(
    ...
    const mostAmount = _.reduce(likeCount, (prev, current) =>
        prev.likes > current.likes ? prev : current
    )
    return mostAmount
}
